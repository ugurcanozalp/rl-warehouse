...
## Scripts
You can find scripts in scripts folder. These scripts can be manipulated as much as required, and can be converted to a jupyter notebook etc. Example usage for DBAC training: 

```bash
python -m scripts.dbac --env_name Hopper-v4 --autotune --target_entropy -1 --beta 0.75
```
