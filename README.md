...
## Scripts
You can find scripts in scripts folder. These scripts can be manipulated as much as required, and can be converted to a jupyter notebook etc. Example usage for OAPC training: 

```bash
python -m scripts.oapc --env_name Hopper-v4 --autotune --target_entropy -1 --beta 0.5
```

## Algorithms implemented
- [x] Optimistic Actor Pessimistic Critic (almost ready)
