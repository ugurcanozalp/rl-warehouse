    ...
    def learn_on_step(self):
        for i in range(self._batch_per_step): 
            ...
            with th.no_grad():
                ...
                next_value_nopess = (next_q_distr.mean + self._alpha * next_entropy) * done.logical_not().unsqueeze(-1)
                ...
                q_target_nopess = reward.unsqueeze(-1) + self._gamma * next_value_nopess
